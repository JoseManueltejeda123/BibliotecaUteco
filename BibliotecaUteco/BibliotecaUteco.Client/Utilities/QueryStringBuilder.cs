...
namespace BibliotecaUteco.Client.Utilities
{
    ...
    /// </summary>
    public static string ToQueryString(Dictionary<string, object> parameters, bool trimStrings = true)
    {
    ...
    /// </summary>
    public static string ToQueryString(object obj, Dictionary<string, string> propertyNameMap, bool trimStrings = true)
    {
        if (obj == null)
            return string.Empty;
        ...
        {
            var value = prop.GetValue(obj);
            var queryParamName = propertyNameMap.ContainsKey(prop.Name) ? propertyNameMap[prop.Name] : prop.Name;
