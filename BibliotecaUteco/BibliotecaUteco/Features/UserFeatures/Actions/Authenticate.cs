...
public class AuthenticateUserCommand : ICommand<IApiResult>
{
    [
        ...
        Description("El nombre de usuario del usuario a iniciar sesión"),
        FromBody,
        MinLength(5),
        MaxLength(15)
    ]
    ...
    [
        ...
        Description("La contraseña del usuario a iniciar sesión"),
        FromBody,
        MinLength(8),
        MaxLength(30)
    ]
...
public class AuthenticateUserCommandValidator : AbstractValidator<AuthenticateUserCommand>
{
    public AuthenticateUserCommandValidator()
    {
        RuleFor(x => x.Username)
            ...
            .MaximumLength(15)
            .WithMessage("El nombre de usuario no puede tener más de 15 caracteres");
        ...
        RuleFor(x => x.Password)
            ...
            .MaximumLength(30)
            .WithMessage("La contraseña no puede tener más de 30 caracteres");
    }
}
...
internal class AuthenticateUserEndpoint : IEndpoint
{
    ...
    {
        app.MapPost(
                EndpointSettings.UsersEndpoint + "/authenticate",
                async (
            ...
            .WithDescription(
                $"Revisa las credenciales de un usuario y emite un {nameof(IApiResult)} con un JWT"
            );
    }
}
...
) : ICommandHandler<AuthenticateUserCommand, IApiResult>
{
