...
public class BibliotecaUtecoDbContext(DbContextOptions<BibliotecaUtecoDbContext> options)
    : DbContext(options),
        IBibliotecaUtecoDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            x.HasMany(b => b.Authors)
                .WithOne(ba => ba.Book)
                .HasForeignKey(ba => ba.BookId)
                .OnDelete(DeleteBehavior.Cascade);
            x.HasMany(b => b.Genres)
                .WithOne(gb => gb.Book)
        ...
        {
            x.HasOne(gb => gb.Book)
                .WithMany(gb => gb.Genres)
                .HasForeignKey(ba => ba.BookId)
                .IsRequired(true);
            x.HasOne(gb => gb.Genre)
                .WithMany(ba => ba.Books)
                .HasForeignKey(ba => ba.GenreId)
                .IsRequired(true);
        ...
        {
            x.HasOne(l => l.Penalty)
                .WithOne(l => l.Loan)
                .HasForeignKey<Penalty>(l => l.LoanId)
                .OnDelete(DeleteBehavior.Restrict);
            x.HasMany(l => l.Books)
                .WithOne(l => l.Loan)
        ...
        {
            x.HasOne(t => t.Penalty)
                .WithOne(p => p.Transaction)
                .HasForeignKey<Penalty>(l => l.TransactionId)
                .OnDelete(DeleteBehavior.Restrict);
            x.HasOne(t => t.User)
