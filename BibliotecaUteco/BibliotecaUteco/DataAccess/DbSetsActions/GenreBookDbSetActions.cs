...
{
    public static async Task SyncGenreBooksAsync(
        this DbSet<GenreBook> dbSet,
        int bookId,
        List<int> genreIds,
    ...
    )
    {
        ...
        await dbSet
            .Where(a => a.BookId == bookId && !newGenres.Contains(a.GenreId))
            .ExecuteDeleteAsync(cancellation);

        var currentGenres = await dbSet
            .AsNoTracking()
            .IgnoreAutoIncludes()
