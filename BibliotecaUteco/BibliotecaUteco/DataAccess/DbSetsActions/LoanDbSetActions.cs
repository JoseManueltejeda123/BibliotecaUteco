...
{
    public static async Task<Loan?> GetByIdAsync(this DbSet<Loan> set, int loanId, CancellationToken cancellationToken = default)
    { 
        return await set.Where(l => l.Id == loanId).Select(l => new Loan
        {
            Id = l.Id,
    ...
    public static async Task<List<Loan>> GetByFilter(this DbSet<Loan> set, 
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            query = query.Where(l => l.Reader != null && !string.IsNullOrEmpty(l.Reader.IdentityCardNumber) && l.Reader.IdentityCardNumber.Contains(identityCardNumber));
        }

        // Filtrar por matrícula estudiantil
        if (!string.IsNullOrWhiteSpace(studentLicence))
        {
            query = query.Where(l => l.Reader != null && !string.IsNullOrEmpty(l.Reader.StudentLicence) && l.Reader.StudentLicence.Contains(studentLicence));
        }
