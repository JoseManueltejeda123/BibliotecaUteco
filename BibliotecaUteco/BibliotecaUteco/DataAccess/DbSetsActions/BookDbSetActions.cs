namespace BibliotecaUteco.DataAccess.DbSetsActions
{
    public static class BookDbSetActions
    {
        ...
        public static async Task<List<Book>> GetByFilterAsync(
            this DbSet<Book> dbSet,
        ...
        )
        {
            ...
            if (!string.IsNullOrWhiteSpace(genreName))
            {
                ...
                query = query.Where(b =>
                    b.Genres.Any(g => g.Genre.NormalizedName.Contains(normalizedGenre))
                );
            }
            ...
            if (!string.IsNullOrWhiteSpace(authorName))
            {
                ...
                query = query.Where(b =>
                    b.Authors.Any(a => a.Author.NormalizedFullName.Contains(normalizedAuthorName))
                );
            }
