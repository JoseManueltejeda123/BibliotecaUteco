...
{
    public static async Task SyncBookAuthorsAsync(
        this DbSet<BookAuthor> dbSet,
        int bookId,
        List<int> authorsIds,
    ...
    )
    {
        ...
        await dbSet
            .Where(a => a.BookId == bookId && !newAuthors.Contains(a.AuthorId))
            .ExecuteDeleteAsync(cancellation);

        var currentAuthors = await dbSet
            .AsNoTracking()
            .IgnoreAutoIncludes()
