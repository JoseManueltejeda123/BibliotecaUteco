...
{
    public static async Task<Reader?> GetByIdAsync(
        this DbSet<Reader> dbSet,
        int readerId,
    ...
    )
    {
        return await dbSet
            ...
            .Select(r => new Reader()
            {
                ...
                LastLoanDate =
                    r.Loans.FirstOrDefault() != null ? r.Loans.FirstOrDefault()!.CreatedAt : null,
    ...
    public static async Task<List<Reader>> GetByFilterAsync(
        this DbSet<Reader> dbSet,
    ...
    )
    {
        ...
        {
            query = query.Where(u =>
                u.StudentLicence != null && u.StudentLicence.Contains(studentLicence)
            );
        }
