    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(1174), "Fantasía", "fantasia", new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(1178) },
                    { 2, new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(3142), "Terror", "terror", new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(3144) },
                    { 3, new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(3149), "Ciencia Ficción", "cienciaficcion", new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(3150) },
                    { 4, new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(3154), "Romance", "romance", new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(3154) },
                    { 5, new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(3157), "Misterio", "misterio", new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(3158) },
                    { 6, new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(3161), "Aventura", "aventura", new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(3161) },
                    { 7, new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(3165), "Histórico", "historico", new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(3166) },
                    { 8, new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(3168), "Biografía", "biografia", new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(3169) },
                    { 9, new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(3172), "Poesía", "poesia", new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(3172) },
                    { 10, new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(3176), "Drama", "drama", new DateTime(2025, 10, 12, 1, 12, 59, 766, DateTimeKind.Utc).AddTicks(3176) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 10, 12, 1, 12, 59, 679, DateTimeKind.Utc).AddTicks(9500), "Librarian", new DateTime(2025, 10, 12, 1, 12, 59, 679, DateTimeKind.Utc).AddTicks(9505) },
                    { 2, new DateTime(2025, 10, 12, 1, 12, 59, 680, DateTimeKind.Utc).AddTicks(1017), "Admin", new DateTime(2025, 10, 12, 1, 12, 59, 680, DateTimeKind.Utc).AddTicks(1020) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 10, 12, 1, 12, 59, 695, DateTimeKind.Utc).AddTicks(1814), "José Apolinar", "00112345678", "973279fd3528bf897629f68765425a6b3e88e35b010c3c3c10a169283a817289", null, 1, new DateTime(2025, 10, 12, 1, 12, 59, 695, DateTimeKind.Utc).AddTicks(1821), "jose.apolinar" },
                    { 2, new DateTime(2025, 10, 12, 1, 12, 59, 743, DateTimeKind.Utc).AddTicks(2369), "Manuel López", "00212345678", "2540fc2a209dd5946b09734722f16821b435db8e376655ab334379a4a0de1133", null, 2, new DateTime(2025, 10, 12, 1, 12, 59, 743, DateTimeKind.Utc).AddTicks(2374), "manuel.lopez" }
                });
